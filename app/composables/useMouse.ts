...
import { createSharedComposable, defaultWindow, unrefElement, useMouse, watchThrottled } from '@vueuse/core'

export const useSharedMouseInElement = (target?: MaybeElementRef, options: MouseInElementOptions = {}) => {
